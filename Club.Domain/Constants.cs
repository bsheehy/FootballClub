...
namespace Club.Domain
{
  public static class Constants
  {
    ...
    public static List<string> AddPersonMembershipRoleNames = new List<string>() { "Administrator", "Super Administrator", "Committe Role" };
    public static List<Guid> PersonMembershipRoleOids = new List<Guid>() { new Guid("058CA795-D577-43AA-958C-769295280D59"), new Guid("058CA795-D577-43AA-958C-769295280D58"), new Guid("67B00F36-F679-4F3D-82DD-5ABD7FAC03E1") };
