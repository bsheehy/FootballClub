...
IF NOT EXISTS(SELECT * FROM [documents_type_path_configuration] WHERE [Oid] = N'0b5db094-b38a-4141-a282-bd1e5dade4cc')
BEGIN
	INSERT [dbo].[documents_type_path_configuration] ([oid], [type], [orev], [applies_to], [path_config]) VALUES (N'0b5db094-b38a-4141-a282-bd1e5dade4cc', N'T', 0, N'Club.Domain.Artifacts.Committee', N'\Committee\[[Oid]]')
END
